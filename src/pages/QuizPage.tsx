                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-3">
                      <span className={`text-[9px] uppercase tracking-[0.3em] font-medium ${isSelected ? 'text-sand/75' : 'text-mist/35'}`}>
                        {option.label}
                      </span>
                      <div className={`h-1.5 w-1.5 rounded-full transition-all duration-200 group-hover:bg-sand/50 ${isSelected ? 'bg-sand/70' : 'bg-white/8'}`}></div>
                    </div>
                    <p className={`text-[14px] leading-[1.5] transition-colors font-light ${isSelected ? 'text-mist/95' : 'text-mist/80 group-hover:text-mist/90'}`}>
                      {option.text}
                    </p>
                  </div>
                </button>
